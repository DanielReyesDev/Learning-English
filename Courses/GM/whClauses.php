...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">WH Clauses</h2><br><br>

		<p><b>Re write these sentences using relative clauses. Use who, whose and which.</b></p><br><br>
		<p>Example:</p><br>
		<p><li>He drank the juice. He made the juice.</li></p>
		<p><li><input type="text" class="borderedInput3" value="drank the juice which he made" disabled="true" required> .</li></p><br><br><br>

		<p>
			<li>A lion is an animal. It is very strong.</li>
			<li>A lion <input id="1" type="text" class="borderedInput3" required> .</li><br><br>

			<li>A novelist is a person. He writes novels.</li>
			<li>A novelist <input id="2" type="text" class="borderedInput3" required> .</li><br><br>

			<li>A bottle opener is a device. It opens bottles.</li>
			<li>A bottle opener <input id="3" type="text" class="borderedInput3" required> .</li><br><br>

			<li>The girl speaks Chinese. Her mother writes poems.</li>
			<li>The girl <input id="4" type="text" class="borderedInput3" required> .</li><br><br>

			<li>A detective is someone. He discovers the truth about crimes.</li>
			<li>A detective <input id="5" type="text" class="borderedInput3" required> .</li><br><br>
