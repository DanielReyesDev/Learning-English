...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">So and Such</h2><br><br><br>
			...
			<div id="table2" class="table-editable">
				<table class="table">
					<tr>
						...
						<td id="upLeft" contenteditable="false">The weather was so ...</td>
						<td contenteditable="false"><input id="1" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">a</td>
						<td id="upRight" contenteditable="false">... I only answered 3 questions.</td>
					</tr>
					<tr>
						
						<td contenteditable="false">It was such a cold day ...</td>
						<td contenteditable="false"><input id="2" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">b</td>
						<td contenteditable="false">... I ate 3 pieces.</td>
					</tr>
					<tr>
						
						<td contenteditable="false">The shoes were so cheap ...</td>
						<td contenteditable="false"><input id="3" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">c</td>
						<td contenteditable="false">... I finished it an hour early.</td>
					</tr>
					<tr>
						
						<td contenteditable="false">It was such an expensive dress ...</td>
						<td contenteditable="false"><input id="4" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">d</td>
						<td contenteditable="false">... I couldn't eat any of it.</td>
					</tr>
					<tr>
						
						<td contenteditable="false">The exam was so difficult that ... </td>
						<td contenteditable="false"><input id="5" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">e</td>
						<td contenteditable="false">... that we couldn't go out at all.</td>
					</tr>
					<tr>
						
						<td contenteditable="false">It was such an easy exam that ...</td>
						<td contenteditable="false"><input id="6" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">f</td>
						<td contenteditable="false">bad that we stayed at home all day. </td>
					</tr>
					<tr>
						
						<td contenteditable="false">The cake was so delicious that ...</td>
						<td contenteditable="false"><input id="7" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">g</td>
						<td contenteditable="false">... that I bought 3 pairs. </td>
					</tr>
					<tr>
						
						<td id="downLeft" contenteditable="false">It was such a horrible cake ...</td>
						<td contenteditable="false"><input id="8" type="text" class="inputInsideTable"></td>
						<td contenteditable="false">h</td>
						<td id="downRight" contenteditable="false">... that I couldn't afford to buy it.</td>
					</tr>
				</table>
			</div>
			<br><br><br>
