...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Relative Pronouns</h2><br><br>

		<p><b>Complete the exercise with  <b style="color:red">who</b>, <b style="color:red">whom</b>, <b style="color:red">whose</b> or <b style="color:red">where</b>.</b></p><br><br>
		

		<p>
			<ol>
				<li>What's the name of the man <select id="1"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> car you borrowed? </li>
				<li>A cemetery is a place <select id="2"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> people are buried. </li>
				<li>A pacifist is a person <select id="3"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> believes that all wars are wrong. </li>
				<li>An orphan is a child <select id="4"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> parents have passed away. </li>
				<li>The town <select id="5"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> we spent the holidays was very beautiful. </li>
				<li>This school is only for children <select id="6"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> first language is not English. </li>
				<li>I don't know the name of the woman to <select id="7"><option>who</option><option>whom</option><option>whose</option><option>where</option></select> I spoke on the phone. </li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
