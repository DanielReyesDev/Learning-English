...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Tomorrow's World</h2><br><br><br>

		<p>Fill the blanks with the correct answer.</p>
		<br><br>
		
		Example: We haven't got a lot of money so we <select disabled="true"><option>couldn't</option><option>may not</option></select> go on holiday next year.<br>
		<br>

		<form>
			<ol type="1">
				
				<li><select id="1"><option>Could</option><option>Will</option></select> you be able to find a good job when you leave school?</li>

				<li>He <select id="2"><option> may probably</option><option>'ll probably</option></select> help you with your homework if you ask him.</li>

				<li>It <select id="3"><option>'ll</option><option>could</option></select> snow later. I’m not sure.</li>

				<li>Who do you think <select id="4"><option>will</option><option>may not</option></select> the next World Cup.</li>

				<li>If you don't revise you <select id="5"><option>couldn't</option><option>won't</option></select> pass the exam.</li>
			</ol>
		</form>
		<br><br>
		<div class="container">
