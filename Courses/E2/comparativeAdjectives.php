...
<body>
	...
	<section class="text">
		...
		<h2 align="center">Comparatives adjectives</h2><br><br><br>
		<p>Make the comparative form.</p><br>
		<p>Example: Dogs are more intelligent (intelligent) than rabbits</p><br>
		
		
		<ol>
			<li>I am <input id="1" class="borderedInput" type="text"> (old) than my sister.</li>
			<li>Puebla is <input id="2" class="borderedInput" type="text"> (beautiful) than México City.</li>
			<li>A holiday by the sea is <input id="3" class="borderedInput" type="text"> (good) than a holiday in the mountains.</li>
			<li>The weather this summer is <input id="4" class="borderedInput" type="text"> (bad) than the last summer.</li>

			<li>My brother is <input id="5" class="borderedInput" type="text"> (tall) than me.</li>
			<li>I am <input id="6" class="borderedInput" type="text"> (good) in English than my father.</li>

			<li>Football is <input id="7" class="borderedInput" type="text"> (popular) than tennis.</li>
		</ol>
