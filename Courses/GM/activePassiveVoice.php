...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Active and Passive Voice</h2><br><br>

		<p><b>Rewrite the following sentences so that the verbs will be in the active voice.</b></p><br><br>
		

		<p>
			<ol>
				<li>We are taught grammar by Ms Sullivan.</li>
				<li>He was praised by the teacher.</li>
				<li>The injured were taken to the hospital by the firemen.</li>
				<li>The town was destroyed by an earthquake.</li>
				<li>The teacher was pleased with the boy’s work.</li>
				<li>The building was damaged by the fire.</li>
				<li>By whom were you taught French?</li>
				<li>You will be given a ticket by the manager.</li>
				<li>The streets were thronged with spectators.</li>
				<li>We will be blamed by everyone.</li>
				<li>The trees were blown down by the wind.</li>
				<li>The thieves were caught by the police.</li>
				<li>The letter was posted by Alice.</li>
				<li>We were received by the hostess.</li>
				<li>The snake was killed with a stick.</li>
				<li>The minister was welcomed by the people.</li>
				<li>He was found guilty of murder.</li>
				<li>This house was built by John Mathews in 1991.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
