...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">DEFINING RELATIVE CLAUSES</h2><br><br>

		<p><b>Make one sentence by changing the sentence in italics into a defining relative clause. The relative pronoun can be the subject or the object of the relative clause.</b></p><br><br>
		

		<p>
			<ol>
				<li>The man was late. Julie invited the man.</li>
				<li>The doctor was sick. I wanted to see the doctor.</li>
				<li>The accountant was arrested. The accountant works for my father’s company.</li>
				<li>I wrote to the friend. You met the friend last week.</li>
				<li>The mobile phone can’t be fixed. The mobile phone is broken.</li>
				<li>John made a copy of the photo. I took the photo.</li>
				<li>I met a girl. The girl was a doctor.</li>
				<li>We called a doctor. The doctor works at a hospital in London.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
