...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">PRESENT OR THE PAST SIMPLE PASSIVE</h2><br><br><br>

		<p><b>Complete with the present or the past simple passive of the verbs in brackets.</b></p><br><br>
		<p>Example: Bill’s clothes are not washed by his mother anymore.</p>

		<br><br>
		<p>
			<ol>
				<li>Jeans are very popular. They <input id="1" type="text" class="borderedInput" required> <b>(wear)</b> by many people.</li>
				<li>Luckily, the fire <input id="2" type="text" class="borderedInput" required> <b>(put out)</b> by the firefighters quickly, so the building <input id="3" type="text" class="borderedInput" required> <b>(not destroy)</b></li>
				<li>Our house <input id="4" type="text" class="borderedInput" required> <b>(paint)</b> every two years.</li>
				<li>My sister <input id="5" type="text" class="borderedInput" required> <b>(not name)</b> Tina. Her name is Tanya.</li>
				<li>Fortunately, the children <input id="6" type="text" class="borderedInput" required> <b>(not hurt)</b> in the accident.</li>
			</ol>
