...
<body>
	...
	<section class="text">
		...
		<p>Choose the option that fits better the following sentences.</p>
		<br><br>
		
		Example: Not being able to sleep at night is called ________.<br>
		<input type="radio" name="respuesta" disabled="true">Sneeze<tab1>
		<input type="radio" name="respuesta"  disabled="true" checked="true">Insomnia
		<br>

		<form>
			<ol type="1">
				
				<li>Some people are <select id="1"><option>allergic</option><option>alergy</option></select> to dogs.</li>

				<li>A doctor who operates on people is called a <select id="2"><option>cardiologist</option><option>surgeon</option></select>.</li>


				<li>My nose has been <select id="3"><option>running</option><option>run</option></select>.</li>

				<li>I <select id="4"><option>have</option><option>am having</option></select> a fever.</li>

				<li>I have a <select id="5"><option>ache</option><option>sore</option></select> throat.</li>

				<li>I have a stomach<select id="6"><option>ache</option><option>sore</option></select>.</li>

				<li>I'm feeling a little under the <select id="7"><option>weather</option><option>sun</option></select>.</li>

				<li>What are your <select id="8"><option>wrong</option><option>symptoms</option></select>?</li>

				<li>Take this <select id="9"><option>prescription</option><option>chemist</option></select> to the Pharmacy and get yout medicine.</li>

				<li>I think I <select id="10"><option>broke</option><option>run</option></select> my ankle.</li>
