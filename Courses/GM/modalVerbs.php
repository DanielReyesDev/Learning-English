...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Past Simple</h2><br><br>

		<p><b>Do the exercises below on used to, be used to, get used to. Choose the correct word.</b></p><br><br>

		
		<p>
			<ol>
				<li>He used to <input id="1" type="text" class="borderedInput" required> fat but now he's thin</li>
				<li>He isn't used to <input id="2" type="text" class="borderedInput" required> in these bad conditions. </li>
				<li>How did you get used to <input id="3" type="text" class="borderedInput" required> in the middle of this mess </li>
				<li>Did you <input id="4" type="text" class="borderedInput" required> write poems when you were young? </li>
				<li>I need some time to get used to <input id="5" type="text" class="borderedInput" required> in this town. </li>
				<li>Sting used to <input id="6" type="text" class="borderedInput" required> a teacher before he became a famous singer. </li>
				<li>I'm not used to <input id="7" type="text" class="borderedInput" required> linen by hand. </li>
				<li>She'll get used to <input id="8" type="text" class="borderedInput" required> in the extremely cold winter of Siberia.</li>
				<li>My mother didn't <input id="9" type="text" class="borderedInput" required> drink much coffee. But now she has become addicted to it </li>
				<li>There used to <input id="10" type="text" class="borderedInput" required> a lot of trees in this court yard. They have all been cut down.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
