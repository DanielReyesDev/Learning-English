...
<body>
	...
	<section class="text">
		...
		<p><b>Complete with past simple (regular verbs).</b></p><br><br>

		
		<p>
			<ol>
				<li>I opened the door and <input id="1" type="text" class="borderedInput" required> <b>(look)</b> inside.</li>
				<li>Who <input id="2" type="text" class="borderedInput" required> <b>(close)</b> all the windows?</li>
				<li>I <input id="3" type="text" class="borderedInput" required> <b>(carry)</b> my mom ́s shopping bag.</li>
				<li>I <input id="4" type="text" class="borderedInput" required> <b>(not climb)</b> over the fence.</li>
				<li>I <input id="5" type="text" class="borderedInput" required> <b>(rip)</b> my shirt.</li>
				<li>The plane <input id="6" type="text" class="borderedInput" required> <b>(land)</b> ten minutes ago.</li>
				<li>We <input id="7" type="text" class="borderedInput" required> <b>(live)</b> in that house when I was a baby.</li>
				<li>My brother <input id="8" type="text" class="borderedInput" required> <b>(not cry)</b> when he fell of his bike.</li>
				<li>We <input id="9" type="text" class="borderedInput" required> <b>(walk)</b> to school yesterday.</li>
				<li>She <input id="10" type="text" class="borderedInput" required> <b>(smile)</b> when she saw me.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
