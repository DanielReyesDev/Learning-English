...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">FUTURE INTENTIONS</h2><br><br>

		<p><b>Choose one word to complete each sentence - <b class="red">must</b>, <b class="red">might</b> or <b class="red">can't</b>. Remember - English people often use <b class="red">must</b> or <b class="red">can't</b> with exclamation marks (!!!).</b></p><br><br>

		<p>
			<ol>
				<li>Sarah never stops talking about Steve. She <input id="1" type="text" class="borderedInput" required> be in love with him!</li>
				<li>You <input id="2" type="text" class="borderedInput" required> hate English food - it's delicious!</li>
				<li>Tom <input id="3" type="text" class="borderedInput" required> be working today - I just saw him at the gym.</li>
				<li>Tom <input id="4" type="text" class="borderedInput" required> be working today, but I can't remember.</li>
				<li>You drank 3 bottles of wine? You <input id="5" type="text" class="borderedInput" required> feel so sick!</li>
				<li>Frank's quite good at grammar. He <input id="6" type="text" class="borderedInput" required> know the answer for this question.</li>
				<li>You studied this for 3 years at university! You <input id="7" type="text" class="borderedInput" required> know the answer!</li>
				<li>You just slept for 12 hours! You <input id="8" type="text" class="borderedInput" required> be tired again already!</li>
				<li>She always gets me a present, but this year she didn't. She <input id="9" type="text" class="borderedInput" required> have forgotten that it's my birthday.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
