...
<body>
	...
	<section class="text">
		...
		<p><b>Complete the following sentences using the correct form of the verbs provided.</b></p><br><br>
		<p>Example: If Omar <select disabled="true"><option>had</option></select> lived in México, he <select disabled="true"><option>would have</option></select> eaten tamales.</p>

		<br><br>
		<p>
			<ol>
				<li>If Gaby had gone to another country, she <select id="1"><option>went</option><option>wouldn't have</option><option>had gone</option></select> celebrated the "day of the dead".</li>
				<li>Fannie <select id="2"><option>would have</option><option>have been</option><option>haven't</option></select> made an offering of the day of the dead, if she <select id="3"><option>hadn't been</option><option>would hasn't</option><option>wouldn't</option></select> Chinese.</li>
				<li>I <select id="4"><option>had eaten</option><option>would have eaten</option><option>would had eaten</option></select> so many tamales, if it had been February 2nd.</li>
				<li>If Anna had <select id="5"><option>gone</option><option>go</option><option>went</option></select> to downtown the September 15th, she would have <select id="6"><option>seen</option><option>see</option></select> the downtown crawled of people.</li>
				<li>My brother wouldn't have to pray to "La virgen de Guadalupe", if he <select id="7"><option>hasn't been</option><option>hadn't be</option><option>hadn't been</option></select> Mexican.</li>
			</ol>
