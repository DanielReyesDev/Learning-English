...
<body>
	...
	<section class="text">
		...
		<p><b>Rewrite the expressions in red and use better verb forms.</b></p><br><br>
		<p>Example: I hope it <b class="red">rains</b> tomorrow. - <input type="text" class="borderedInput2" value="will rain" disabled="true" required></p><br><br>

		<p>
			<li>I am going to the cinema tonight. - Yes? I <b class="red">am joining</b> you. - <input id="1" type="text" class="borderedInput2" required></li>
			<li>Announcement: The new supermarket <b class="red">is going to open</b> on 1 May. - <input id="2" type="text" class="borderedInput2" required></li>
			<li>Why are you wearing the swimsuit? - I <b class="red">take</b> a bath. - <input id="3" type="text" class="borderedInput2" required></li>
			<li>Can you see the grey sky? It <b class="red">is snowing</b> soon. - <input id="4" type="text" class="borderedInput2" required></li>
			<li>I must go now. I <b class="red">play</b> tennis with Greg tonight. - <input id="5" type="text" class="borderedInput2" required></li>
			<li>Hurry up. The train <b class="red">is leaving</b> in ten minutes. - <input id="6" type="text" class="borderedInput2" required></li>
