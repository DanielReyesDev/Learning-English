...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">TAG QUESTIONS 2</h2><br><br><br>

		<p><b>Answer to the following positive and negative tag questions.</b></p><br><br>
		<p>Example: One of the main challenges facing Mexico to the environment and sustainable development is to include the former as one of the elements of competitiveness and economic and social development, <input type="text" class="borderedInput" disabled="true" value="isn't it" required> ?</p>

		<br><br>
		<p>
			<ol>
				<li>México is a country with a huge diversity of ecological conditions, <input id="1" type="text" class="borderedInput" required> ?</li>
				<li>The natural resources of Mexico are exceptionally rich in both flora and fauna <input id="2" type="text" class="borderedInput" required> ?</li>
				<li>Non-renewable resources are those that once they are used are depleted <input id="3" type="text" class="borderedInput" required> ?</li>
				<li>Mexico is a big producer of farm products, <input id="4" type="text" class="borderedInput" required> ?</li>
				<li>Mexico isn't the leading producer of oil, <input id="5" type="text" class="borderedInput" required> ?</li>
			</ol>
