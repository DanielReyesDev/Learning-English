...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Simple Future</h2><br><br>

		<p><b>Put the verbs into the correct form (simple future)</b></p><br><br>
		<p>James, 18 years old, asked an ugly fortune teller about his future. Here is what she told him:</p><br>

		
		<p>
			<li>You (be) <input id="1" type="text" class="borderedInput2" required> very happy.</li>
			<li>You (get) <input id="2" type="text" class="borderedInput2" required> a lot of money.</li>
			<li>You (buy) <input id="3" type="text" class="borderedInput2" required> a beautiful house.</li>
			<li>Your friends (envy) <input id="4" type="text" class="borderedInput2" required> you.</li>
			<li>You (meet) <input id="5" type="text" class="borderedInput2" required> a beautiful girl.</li>
			<li>You (marry) <input id="6" type="text" class="borderedInput2" required> her.</li>
			<li>You and your wife (travel) <input id="7" type="text" class="borderedInput2" required> around the world.</li>
			<li>People (serve) <input id="8" type="text" class="borderedInput2" required> you.</li>
			<li>They (not/refuse) <input id="9" type="text" class="borderedInput2" required> to make you happy.</li>
			<li>But all this (happen / only) <input id="10" type="text" class="borderedInput2" required> when you are 70 years old.</li>
