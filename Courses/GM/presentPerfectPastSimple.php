...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Present Perfect vs Past Simple</h2><br><br>
		...
		<p>
			<ol>
				<li>Mother: I want to prepare dinner. (you / wash) <input id="1" type="text" class="borderedInput2" required> the dishes yet?</li>
				<li>Daughter: I (wash) <input id="2" type="text" class="borderedInput2" required> the dishes yesterday, but I <input id="3" type="text" class="borderedInput2" required> (have / not)  the time yet to do it today.</li>
				<li>Mother: (you / do / already) <input id="4" type="text" class="borderedInput2" required> your homework?</li>
				<li>Daughter: No, I (come / just) <input id="5" type="text" class="borderedInput2" required>  home from school.</li>
				<li>Mother: You (come) <input id="6" type="text" class="borderedInput2" required> home from school two hours ago!</li>
				<li>Daughter: Well, but my friend Lucy (call) <input id="7" type="text" class="borderedInput2" required> when I (arrive) <input id="8" type="text" class="borderedInput2" required> and I (finish / just) <input id="8" type="text" class="borderedInput2" required> the phone call.</li>
				<li>Mother: (you / see / not) <input id="9" type="text" class="borderedInput2" required> Lucy at school in the morning?</li>
				<li>Daughter: Yes, but we (have / not) <input id="10" type="text" class="borderedInput2" required> time to talk then.</li>				
			</ol>
		</p>
		<br><br><br>
		<div class="container">
