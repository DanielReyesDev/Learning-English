...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">COMPARATIVES AND SUPERLATIVES</h2><br><br>

		<p><b>Put the adjectives between brackets in the correct form.</b></p><br><br>
		

		<p>
			<ol>
				<li>My brother has a <input id="1" type="text" class="borderedInput" required> (tidy) room than me.</li>
				<li>Australia is <input id="2" type="text" class="borderedInput" required> (big) than England.</li>
				<li>I'm <input id="3" type="text" class="borderedInput" required> (good) now than yesterday.</li>
				<li>She's got <input id="4" type="text" class="borderedInput" required> (little) money than you, but she doesn't care.</li>
				<li>He thinks Chinese is <input id="5" type="text" class="borderedInput2" required>  (difficult) language in the world</li>
				<li>Valencia played <input id="6" type="text" class="borderedInput" required> (bad) than Real Madrid yesterday.</li>
				<li>Cats are not <input id="7" type="text" class="borderedInput2" required> (intelligent) as dogs.</li>
				<li>Show me <input id="8" type="text" class="borderedInput2" required> (good) restaurant downtown.</li>
				<li><input id="9" type="text" class="borderedInput2" required> (hot) desert of all is the Sahara and it's in Africa.</li>
				<li>Who is <input id="10" type="text" class="borderedInput2" required> (talkative) person in your family?</li>
