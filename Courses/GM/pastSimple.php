...
<body>
	...
	<section class="text">
		...
		<p>Example: I didn't watch TV last night.</p>

		<br><br>
		<p>
			<ol>
				<li>On Saturday I <input id="1" type="text" class="borderedInput" required> <b>(play)</b> computer games with my cousins.</li>
				<li>My mum <input id="2" type="text" class="borderedInput" required> <b>(not cook)</b> dinner last night.</li>
				<li>I <input id="3" type="text" class="borderedInput" required> <b>(walk)</b> to school because there weren ́t any buses.</li>
				<li>They <input id="4" type="text" class="borderedInput" required> <b>(not dance)</b> at the party.</li>
				<li>My brother <input id="5" type="text" class="borderedInput" required> <b>(travel)</b> to Ireland last summer.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
