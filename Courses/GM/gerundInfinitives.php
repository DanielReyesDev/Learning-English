...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">GERUNDS AND INFINITIVES</h2><br><br>

		<p><b>Complete the following exercise with <b style="color:red">gerund</b> or <b style="color:red">infinitive</b> forms of the indicated verbs. </b></p><br><br>
		

		<p>
			
			<ol type="a">
				<li>What do you want <input id="1" type="text" class="borderedInput" required> (do) tonight? </li>
				<li>I feel like <input id="2" type="text" class="borderedInput" required> (go) to a movie.</li>
			</ol><br>
			<ol type="a">
				<li>It's not so bad <input id="3" type="text" class="borderedInput" required> (tell) a white lie, is it?  </li>
				<li>I don't think <input id="4" type="text" class="borderedInput" required> (lie) is ever right.</li>
			</ol><br>
			<ol type="a">
				<li>It isn't wrong <input id="5" type="text" class="borderedInput" required> (defend) yourself, is it?  </li>
				<li>I think <input id="6" type="text" class="borderedInput" required> (defend) yourself is the right thing to do if you have a good reason.</li>
			</ol><br>
			<ol type="a">
				<li>Why did you end up <input id="7" type="text" class="borderedInput" required> (major) in forestry?</li>
				<li>I've always loved <input id="8" type="text" class="borderedInput" required> (be) outdoors. And I've always had trouble <input id="9" type="text" class="borderedInput" required> (do) desk jobs.</li>
			</ol><br>
