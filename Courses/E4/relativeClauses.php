...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">RELATIVE CLAUSES (DEFINING AND NON-DEFINING CLAUSES)</h2><br><br><br>

		<p><b>Chose the correct option for the relative clauses (defining and non-defining clauses).</b></p><br><br>
		<p>Example: Francisco villa, <select disabled="true"><option>who</option></select> was born June 5, 1978, was a Mexican revolutionary leader.</p>

		<br><br>
		<p>
			<ol>
				<li>Venustiano Carranza, <select id="1"><option>that</option><option>whom</option><option>who</option></select> was a politician, was a promoter of the Mexican Constitution of 1917.</li>
				<li>Emiliano Zapata formulated his own land reform program <select id="2"><option>whom</option><option>which</option><option>that</option></select> was known as Plan de Ayala.</li>
				<li>Mexicans <select id="3"><option>what</option><option>whose</option><option>whom</option></select> traditions are foreign, will lost their own culture.</li>
				<li>Emiliano <select id="4"><option>who</option><option>whose</option><option>that</option></select> loved the poor, he wanted to give them freedom.</li>
				<li>Francisco Villa <select id="5"><option>which</option><option>that</option><option>who</option></select> was a powerful figure had a lot of women.</li>
