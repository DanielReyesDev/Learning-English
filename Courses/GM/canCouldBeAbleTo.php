...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">Ability Can, Could, Be able to, Manage to</h2><br><br>

		<p><b>Complete the sentences with the correct form of the verbs below. Use contractions where possible.</b></p><br><br>

		<p>
			<section class="container">
				<div id="box" class="box show-front">
					<figure>be able to</figure>
					<figure>can</figure>
					<figure>could</figure>
					<figure>manage</figure>
					<figure>succeed</figure>
				</div>
			</section><br><br>

			<ol>
				<li>I <input id="1" type="text" class="borderedInput2" required> understand a word she said. She spoke too quickly.</li>
				<li><input id="2" type="text" class="borderedInput2" required> to use a computer is a requirement of many jobs today.</li>
				<li>I think I know what's wrong with the TV. I might <input id="3" type="text" class="borderedInput2" required> fix it.</li>
				<li>We were surprised when Chris <input id="4" type="text" class="borderedInput2" required> to pass his driving test first time.</li>
				<li>The music from Beth's house was really loud, I'm sure everyone for miles around <input id="5" type="text" class="borderedInput2" required> hear it.</li>
				<li>It was only after hours of climbing, that they <input id="6" type="text" class="borderedInput2" required> in reaching the top of the mountain.</li>
				<li>I've got lessons all morning, so I <input id="7" type="text" class="borderedInput2" required> meet you until the afternoon.</li>
				<li>Do you think you'll <input id="8" type="text" class="borderedInput2" required> finish this assignment for tomorrow?</li>
