...
<body>
	...
	<section class="text">
		...
		<p><b>Choose the correct option for the second conditional sentences.</b></p><br><br>
		<p>Example: If México had not much biodiversity, it <select disabled="true"><option>wouldn't have</option></select> a lot of tourists.</p>

		<br><br>
		<p>
			<ol>
				<li>I <select id="1"><option>would go</option><option>will go</option><option>would gone</option></select> on a trip to Chihuahua, if it had a lot of flora.</li>
				<li>If I could swim, I <select id="2"><option>wouldn't gone</option><option>would gone</option><option>would go</option></select> to Cancun.</li>
				<li>If Mexicans knew how to take advantage of their natural resources, they <select id="3"><option>could benefits</option><option>could benefit</option><option>couldn't benefit</option></select> the whole nation.</li>
				<li>If Mexico <select id="4"><option>could produce</option><option>couldn't produce</option><option>could produces</option></select> more petrol, he would be richer.</li>
			</ol>
