...
<body>
	...
	<section class="text">
		...
		<p><b>Complete the exercise with the correct forms of the phrasal verbs in the boxes.</b></p><br><br>
		...
		<p>
			<section class="container">
				<div id="box" class="box show-front">
					<figure>hang up</figure>
					<figure>let down</figure>
					<figure>throw out</figure>
					<figure>end up with</figure>
				</div>
			</section>

			<ol>
				<li>I just <input id="1" type="text" class="borderedInput2" required> my first issue of Motorcycle Mama. I'm nobody's mama </li>
				<li>and I don't own a motorcycle, so how did I <input id="2" type="text" class="borderedInput2" required> this subscription? </li>
				<li>Well, my neighbor's son was raising money for his soccer team, and </li>
				<li>I didn't want to <input id="3" type="text" class="borderedInput2" required> him <input id="4" type="text" class="borderedInput2" required>. It's easy to <input id="5" type="text" class="borderedInput2" required> on </li>
				<li>telemarketers, but it's hard to say no to your friends and neighbors.</li>
			</ol>
			<br><br><br>
			<section class="container">
				<div id="box" class="box show-front">
					<figure>get to</figure>
					<figure>help out</figure>
					<figure>watch out for</figure>
					<figure>fall for</figure>
				</div>
			</section>

			<ol>
				<li>The magazine company <input id="6" type="text" class="borderedInput2" required> me through a friendship. It's one of </li>
				<li>the ways "persuasion professionals" get us to say yes. Of course it's OK to</li>
				<li><input id="7" type="text" class="borderedInput2" required> the local soccer team. But a lot of people <input id="8" type="text" class="borderedInput2" required> scams </li>
				<li>because of similar techniques.<input id="9" type="text" class="borderedInput2" required> these common scams.</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
