...
<body>
	...
	<section class="text">
		...
		<p>Complete the sentences using the superlative form of the adjectives in brackets.</p><br><br>

		

		
	
		<p>Example: My brother is the funniest (funny) person I know.</p>
		<ol>
			<li>Peter is <input id="1" class="borderedInput" type="text"> (good) teacher in the school.</li>
			<li>I am <input id="2" class="borderedInput" type="text"> (tall) boy in the class.</li>
			<li>My sister is <input id="3" class="borderedInput" type="text"> (intelligent) student in the school.</li>
			<li>My dad is <input id="4" class="borderedInput" type="text"> (strong) in the house.</li>
			<li>Today is <input id="5" class="borderedInput" type="text"> (sunny) day of the month. </li>
			<li>My grandfather is <input id="6" class="borderedInput" type="text"> (old) of the family.</li>
			<li>My sister and I are <input id="7" class="borderedInput" type="text"> (young) of the family.</li>
			<li>Mexico is <input id="8" class="borderedInput" type="text"> (beautiful) place in the world.</li>
		</ol>
