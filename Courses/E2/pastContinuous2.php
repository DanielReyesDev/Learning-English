...
<body>
	...
	<section class="text">
		...
		<p>Complete the sentences with past simple or past continuous.</p><br><br>

		<ol>
			<li>While I (walk) <input id="1" class="borderedInput" type="text"> home from school, I (see) <input id="2" class="borderedInput" type="text"> a man stealing a car.</li>

			<li>My mother (arrive) <input id="3" class="borderedInput" type="text"> home when I (eat) <input id="4" class="borderedInput" type="text">.</li>

			<li>I (think) <input id="5" class="borderedInput" type="text"> about my father when suddenly I (see) <input id="6" class="borderedInput" type="text"> him in the street.</li>


			<li>My best friend (drive) <input id="7" class="borderedInput" type="text"> when a dog (run) <input id="8" class="borderedInput" type="text"> across the road.</li>


			<li>While Erica (have) <input id="9" class="borderedInput" type="text"> a haircut, her sister (read) <input id="10" class="borderedInput" type="text"> magazines.</li>
