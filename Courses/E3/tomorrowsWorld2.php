...
<body>
	...
	<section class="text">
		...
		<p>Fill the blanks with the correct form of the words at the end of the sentence.</p>
		<br><br>
		...
		<form>
			<ol type="1">
				...
				<li>I was <input id="1" type="text" class="borderedInput" required> about who to choose but there was no more time to think. -- CERTAINTY</li>

				<li>He <input id="2" type="text" class="borderedInput" required> has a lot of money, just look at that watch! -- OBVIOUSNESS</li>

				<li>It is <input id="3" type="text" class="borderedInput" required> that it might rain. -- POSSIBLY</li>

				<li>There is a slight <input id="4" type="text" class="borderedInput" required> of rain. -- POSSIBLY</li>

				<li>I have a sense of <input id="5" type="text" class="borderedInput" required> about this investment. -- OPTIMISTIC</li>

				<li>It is <input id="6" type="text" class="borderedInput" required> whether they ever get a refund. -- DOUBT</li>
