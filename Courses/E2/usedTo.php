...
<body>
	...
	<section class="text">
		...
		<p>Make an affirmative sentence, negative sentence or question using "used to + infinitive".</p><br>
		<p>Example: I/ live in Puebla when I was a child.</p>
		<input type="text" name="sentence1" class="largeInput" value="I used to live in Puebla when I was a child." disabled="true"><br><br><br>


		<ol>
			<li>We/ go to the mountains every summer.</li><input id="1" type="text" name="sentence1" class="largeInput" required><br><br>
			<li>My sister/ love eating chocolate, but now she hates it.</li><input id="2" type="text" name="sentence1" class="largeInput" required><br><br>
			<li>My father/ not/ smoke when he was a teenager.</li><input id="3" type="text" name="sentence1" class="largeInput" required><br><br>
			<li>1.	I/ play football when I was in secondary school.</li><input id="4" type="text" name="sentence1" class="largeInput" required><br><br>

		</ol>

		<p>Source: <a href="http://www.perfect-english-grammar.com/used-to-exercise-1.html">perfect-english-grammar</a></p>
