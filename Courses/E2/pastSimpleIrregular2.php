...
<body>
	...
	<section class="text">
		...
		<p>Put the verbs into simple past</p>
		<p>Example: Last year I <input class="borderedInput" type="text" value="went" disabled="true">(go) to Chiapas for holidays.</p>

		<ol>
			<li>It <input id="1" class="borderedInput" type="text" > (be) fantastic visiting my grandmother and my grandfather.</li>
			<li>I <input id="2" class="borderedInput" type="text" > (visit) lot of interesting places. I <input id="3" class="borderedInput" type="text" > (be) with my brothers.</li>
			<li>In the morning we <input id="4" class="borderedInput" type="text" > (walk) in the streets of Tuxla.</li>
			<li>In the evening we <input id="5" class="borderedInput" type="text" > (go) to the beach.</li>

			<li>It <input id="6" class="borderedInput" type="text" > (not/rain) a lot.</li>
			<li>But we <input id="7" class="borderedInput" type="text" > (see) a lot of rainbows.</li>

			<li>Where <input id="8" class="borderedInput" type="text" > (spend/you) your last holidays.</li>
		</ol>
		<br><br><br>
