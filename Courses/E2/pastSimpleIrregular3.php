...
<body>
	...
	<section class="text">
		...
		<p>Complete the table with simple past</p>

		<div id="tableWrapper">
			<div id="table2" class="table-editable">
				<table class="table" >
					<tr>
						<th id="upLeft">Affirmative</th>
						<th >Interrogative</th>
						<th id="upRight">Negative</th>
					</tr>
					<tr>
						<td contenteditable="false"><input type="text" class="inputInsideTable2" value="He ate with his sister" disabled="true"></td>
						<td contenteditable="false"><input type="text" class="inputInsideTable2" value="Did he eat with his sister?" disabled="true"></td>
						<td contenteditable="false"><input type="text" class="inputInsideTable2" value="He did not eat with his sister" disabled="true"></td>
					</tr>
					<tr>
						<td contenteditable="false"><input id="1" type="text" class="inputInsideTable2"></td>
						<td contenteditable="false"><input type="text" class="inputInsideTable2" value="Did she speak with her mother?" disabled="true"></td>
						<td contenteditable="false"><input id="2" type="text" class="inputInsideTable2"></td>
					</tr>
					<tr>
						<td id="downLeft" contenteditable="false"><input id="3" type="text" class="inputInsideTable2"></td>
						<td contenteditable="false"><input id="4" type="text" class="inputInsideTable2"></td>
						<td id="downRight" contenteditable="false"><input type="text" class="inputInsideTable2" value="He did not sing in kindergarten." disabled="true"></td>
					</tr>
				</table>
			</div>
			<br><br><br>
