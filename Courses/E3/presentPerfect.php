...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">What have you done?</h2><br><br><br>

		<p>Fill in the blanks using ever, never, just, already and yet.</p>
		<br><br>
		...
		<form>
			<ol type="1">
				...
				<li>Example: Have you <input type="text" class="borderedInput" value="ever" disabled="true" required> been in America?</li>

				<li>Do you hear that noise? The train has  <input id="1" type="text" class="borderedInput" required> arrived?</li>

				<li>No. Your cousin hasn't come to the party <input id="2" type="text" class="borderedInput" required>.</li>

				<li>Can you open the door? Oh it's <input id="3" type="text" class="borderedInput" required> open.</li>

				<li>Your daughter has <input id="4" type="text" class="borderedInput" required> returned home. You don´t have to worry anymore.</li>

				<li>Haven´t you finished your food <input id="5" type="text" class="borderedInput" required> ? No, I’m still eating mom.</li>

				<li>I´m a very lucky person. I have <input id="6" type="text" class="borderedInput" required> had nightmares.</li>

				<li>Are you going to meet me at the shop? Yes, I am <input id="7" type="text" class="borderedInput" required> there.</li>

				<li>I have <input id="8" type="text" class="borderedInput" required> realized how beautiful you are.</li>

				<li>Would you like to have dinner with us? No thanks, I have <input id="9" type="text" class="borderedInput" required> had dinner.</li>

				<li>Have you <input id="10" type="text" class="borderedInput" required> seen such a big ant?</li>
