...
<body>
	...
	<section class="text">
		...
		<p>Put the verbs into the correct form (past progressive)</p><br><br>

		<ol>
			<li>When I phoned my friends, the (play) <input id="1" class="borderedInput" type="text"> monopoly.</li>
			<li>Yesterday at six I (prepare) <input id="2" class="borderedInput" type="text"> dinner</li>
			<li>My cousins (play) <input id="3" class="borderedInput" type="text"> in the garden when it suddenly began to rain.</li>
			<li>I (practice) <input id="4" class="borderedInput" type="text"> the guitar when my mother came home.</li>
			<li>My father (run) <input id="5" class="borderedInput" type="text"> before he took a shower.</li>
			<li>While I (work) <input id="6" class="borderedInput" type="text"> in my room, my friends went to the mall.</li>
			<li>I tried to tell the truth to my mother but she (not/listen) <input id="7" class="borderedInput" type="text"> </li>
			<li>What (you/do) <input id="8" class="borderedInput" type="text"> yesterday when I arrived school.</li>
			<li>I (listen) <input id="9" class="borderedInput" type="text"> to music while my sister (watch) <input id="10" class="borderedInput" type="text"> tv</li>
			<li>We (study) <input id="11" class="borderedInput" type="text"> English yesterday at 4:00 pm when my mother phoned me.</li>
		</ol>
