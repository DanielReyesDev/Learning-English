...
<body>
	...
	<section class="text">
		...
		<p>Read the following descriptions and write the name of the stores in the line</p><br>

		<form>
			<ol>
				<li><input type="text" class="borderedInput" value="Bakery" readonly required> Place where you can buy bread.</li>
				<li><input id="1" type="text" class="borderedInput" required> Place where you can buy meat.</li>
				<li><input id="2" type="text" class="borderedInput" required> Place where you buy gas.</li>
				<li><input id="3" type="text" class="borderedInput" required> Place where firefighters work.</li>
				<li><input id="4" type="text" class="borderedInput" required> Place where you can buy plane tickets and plan trips.</li>
				<li><input id="5" type="text" class="borderedInput" required> Place where you can park your car.</li>
				<li><input id="6" type="text" class="borderedInput" required> Place where you drink coffee.</li>
				<li><input id="7" type="text" class="borderedInput" required> Place where you where you can buy ice cream.</li>
				<li><input id="8" type="text" class="borderedInput" required> Place where you exercise yourself</li>
				<li><input id="9" type="text" class="borderedInput" required> Place where you take trains to travel.</li>
