...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">FUTURE TENSES (WILL – GOING TO – PRESENT CONTINUOUS)</h2><br><br>

		<p><b>Use the verbs in brackets in the correct future tenses – will-future, going to-future, Simple Present or Present Progressive.</b></p><br><br>
		

		<p>
			<ol>
				<li>The train <input id="1" type="text" class="borderedInput2" required> at 11:45. (to leave)</li>
				<li>We <input id="2" type="text" class="borderedInput2" required> dinner at a nice restaurant on Saturday. (to have)</li>
				<li>It <input id="3" type="text" class="borderedInput2" required> in the mountains tomorrow evening. (to snow)</li>
				<li>On Sunday at 8 o'clock I <input id="4" type="text" class="borderedInput2" required> my friend. (to meet)</li>
				<li>They <input id="5" type="text" class="borderedInput2" required> to London on Friday evening. (to fly)</li>
				<li>Wait! I <input id="6" type="text" class="borderedInput2" required> you to the station. (to drive)</li>
				<li>The English lesson <input id="7" type="text" class="borderedInput2" required> at 8:45. (to start)</li>
				<li>I <input id="8" type="text" class="borderedInput2" required> my sister in April. (to see)</li>
				<li>Look at the clouds - it <input id="9" type="text" class="borderedInput2" required> in a few minutes. (to rain)</li>
				<li>Listen! There's someone at the door. I <input id="10" type="text" class="borderedInput2" required> the door for you. (to open)</li>
			</ol>
		</p>
		<br><br><br>
		<div class="container">
