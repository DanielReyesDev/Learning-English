...
<body>
	...
	<br><br><br><br><br>
	<section class="text">
		<h2 align="center">SECOND CONDITIONAL</h2><br><br><br>

		

		<p><b>Complete the conditional sentences by putting the verbs into the correct form.</b></p><br><br>
		<p>Example: If I <input type="text" class="borderedInput" value="traveled" disabled="true" required> <b>(travel)</b> to Zacatlán I would eat apples.</p>
		<br><br>

		
		<p>
			<ol>
				<li>If I <input id="1" type="text" class="borderedInput" required> <b>(know)</b> how to swim, I might go to Puerto Vallarta.</li>
				<li>If I <input id="2" type="text" class="borderedInput" required> <b>(live)</b> in Puebla, I might climb the "Popocatepetl" volcano.</li>
				<li>If Mexicans <input id="3" type="text" class="borderedInput" required> <b>(be)</b> more aware of their natural resources, they might take care of them.</li>
				<li>If my father <input id="4" type="text" class="borderedInput" required> <b>(go)</b> to the river, we could eat fish.</li>
				<li>If I <input id="5" type="text" class="borderedInput" required> <b>(visit)</b> Chiapas, I could drink a lot of coffee.</li>
				<li>If I <input id="6" type="text" class="borderedInput" required> <b>(find)</b> petrol, I would be reach.</li>
				<li>If I <input id="7" type="text" class="borderedInput" required> <b>(have)</b> a big hectare, I could cultivate corn.</li>
				<li>If my mother <input id="8" type="text" class="borderedInput" required> <b>(go)</b> to Pachuca, she would buy ring made of silver.</li>
			</ol>
